...
class Dialog_export(Gtk.Dialog):
    def __init__(self, parent):
        super().__init__(title="Export data of Flatpak applications", transient_for=parent, flags=0)
        self.add_buttons(
        ...
        label = Gtk.Label()
        label.set_markup("<b>Done!</b> Data has been exported successfully. Is in the directory: <i>%s/Flatpak_Apps_Data/Flatpak_Apps_Data_%s.tar.gz</i>" % (HOME, date)
